...
<footer
  class="flex flex-col items-center bg-zinc-100 text-center text-surface light:bg-white light:text-white">
  <div class="container px-6 pt-6">
    ...
    <div class="mb-6 flex justify-center space-x-2">
      <a
        href="/"
        type="button"
        class="rounded-full bg-white p-3 uppercase leading-normal text-surface shadow-dark-3 shadow-black/30 transition duration-150 ease-in-out hover:shadow-dark-1 focus:shadow-dark-1 focus:outline-none focus:ring-0 active:shadow-1 dark:bg-gray-400 dark:text-white"
  ...
  <!-- Copyright section -->
  <div class="w-full bg-zinc-100 text-black p-4 text-center">© 2024 Copyright ' Ni Jolin Ni Jolan '
  </div>
</footer>